...
#define RS485_TX_GPIO_CLK_ENABLE()          do{ RCC->AHB4ENR |= 1 << 0; }while(0)   /* PA口时钟使能 */

#define RS485_RX_GPIO_PORT                  GPIOA
#define RS485_RX_GPIO_PIN                   SYS_GPIO_PIN3
#define RS485_RX_GPIO_AF                    7                                       /* AF功能选择 */
#define RS485_RX_GPIO_CLK_ENABLE()          do{ RCC->AHB4ENR |= 1 << 0; }while(0)   /* PA口时钟使能 */

#define RS485_UX                            USART2
#define RS485_UX_IRQn                       USART2_IRQn
#define RS485_UX_IRQHandler                 USART2_IRQHandler
#define RS485_UX_CLK_ENABLE()               do{ RCC->APB1LENR |= 1 << 17; }while(0) /* USART2 时钟使能 */
...
void rs485_tx_set(uint8_t en);                      /* RS485 TX模式 */
