...
uint8_t nand_init(void)
{
    ...
    tempreg |= 1 << 9;                      /* 设置TCLR(tCLR=CLE到RE的延时)=(TCLR+SET+2)*fmc_ker_ck,fmc_ker_ck=1/220=4.5ns,对应tCLR,最少10ns */
    tempreg |= 1 << 13;                     /* 设置TAR(tAR=ALE到RE的延时)=(TAR+SET+2)*fmc_ker_ck,fmc_ker_ck=1/220=4.5ns,对应tAR,最少10ns */
