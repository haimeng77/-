...
struct _m_usmart_nametab usmart_nametab[] =
{
    ...
    (void *)ftl_find_same_plane_unused_block, "uint32_t ftl_find_same_plane_unused_block(uint32_t sblock)",
    (void *)ftl_lbn_to_pbn, "uint16_t ftl_lbn_to_pbn(uint32_t lbnnum)",
    (void *)ftl_create_lut, "uint8_t ftl_create_lut(uint8_t mode)",
