...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef * pdev)
{
    ...
    /* 设置LL驱动相关参数 */
    g_pcd_usb_otg_fs.Instance = USB2_OTG_FS;                /* 使用USB2 OTG */
    ...
    g_pcd_usb_otg_fs.Init.low_power_enable = 0;             /* 不使能低功耗模式 */
    ...
    g_pcd_usb_otg_fs.Init.vbus_sensing_enable = 0;          /* 不使能VBUS检测 */
    ...
    HAL_PCD_Init(&g_pcd_usb_otg_fs);                        /* 初始化LL驱动 */
