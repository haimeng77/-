...
#define ATIM_TIMX_NPWM_CHY_GPIO_CLK_ENABLE()    do{ RCC->AHB4ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_COMP_CH1_GPIO_CLK_ENABLE()    do{ RCC->AHB4ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_COMP_CH2_GPIO_CLK_ENABLE()    do{ RCC->AHB4ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_COMP_CH3_GPIO_CLK_ENABLE()    do{ RCC->AHB4ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_COMP_CH4_GPIO_CLK_ENABLE()    do{ RCC->AHB4ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
...
#define ATIM_TIMX_CPLM_CHY_GPIO_CLK_ENABLE()    do{ RCC->AHB4ENR |= 1 << 4; }while(0)       /* PE口时钟使能 */
...
#define ATIM_TIMX_CPLM_CHYN_GPIO_CLK_ENABLE()   do{ RCC->AHB4ENR |= 1 << 4; }while(0)       /* PE口时钟使能 */
...
#define ATIM_TIMX_CPLM_BKIN_GPIO_CLK_ENABLE()   do{ RCC->AHB4ENR |= 1 << 4; }while(0)       /* PE口时钟使能 */
...
#define ATIM_TIMX_PWMIN_CHY_GPIO_CLK_ENABLE()   do{ RCC->AHB4ENR |= 1 << 2; }while(0)       /* PC口时钟使能 */
