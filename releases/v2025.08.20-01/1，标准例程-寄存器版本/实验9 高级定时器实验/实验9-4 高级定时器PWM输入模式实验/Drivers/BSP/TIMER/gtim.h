...
#define GTIM_TIMX_CAP_CHY_CLK_ENABLE()      do{ RCC->APB1LENR |= 1 << 3; }while(0)  /* TIM5 时钟使能 */
...
#define GTIM_TIMX_CNT_CHY_GPIO_CLK_ENABLE() do{ RCC->AHB4ENR |= 1 << 0; }while(0)   /* PA口时钟使能 */
...
#define GTIM_TIMX_CNT_CHY_CLK_ENABLE()      do{ RCC->APB1LENR |= 1 << 0; }while(0)  /* TIM2 时钟使能 */
