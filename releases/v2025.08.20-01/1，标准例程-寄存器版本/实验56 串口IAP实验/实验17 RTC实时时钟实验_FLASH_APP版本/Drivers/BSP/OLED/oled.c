...
void oled_init(void)
{
    ...
    RCC->AHB4ENR |= 0X0F;   /* 使能PORTA/B/C/D时钟 */
    RCC->AHB4ENR |= 1 << 7; /* 使能PORTH时钟 */

    sys_gpio_set(GPIOA, SYS_GPIO_PIN15,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PA15设置 */

    sys_gpio_set(GPIOB, SYS_GPIO_PIN3 | SYS_GPIO_PIN4 | SYS_GPIO_PIN7 | SYS_GPIO_PIN8 | SYS_GPIO_PIN9,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PB3,4,7,8,9设置 */
    ...
    sys_gpio_set(GPIOD, SYS_GPIO_PIN3,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PD3 设置 */

    sys_gpio_set(GPIOH, SYS_GPIO_PIN8,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PH8 设置 */
