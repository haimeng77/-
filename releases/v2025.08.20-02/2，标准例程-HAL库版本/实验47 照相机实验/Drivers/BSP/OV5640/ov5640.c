...
/**
 * @brief       初始化OV5640 
 * @note        配置完以后,默认输出是1600*1200尺寸的图片!! 
 * @param       无
 * @retval      0,成功
 * @retval      其他,错误代码
 */
...
{ 
    ...
    OV_RESET_GPIO_CLK_ENABLE();                               /* RST引脚时钟使能 */
...
void ov5640_rgb565_mode(void) 
{
    ...
    if (lcdltdc.pwidth != 0)
    {
        ov5640_write_reg(0X3821, 0X06);             /* RGB屏,水平镜像 */
    }
} 
