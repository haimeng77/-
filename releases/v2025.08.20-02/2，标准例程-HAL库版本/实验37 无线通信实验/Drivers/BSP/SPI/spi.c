...
void spi2_init(void)
{
    ...
    g_spi2_handle.Init.NSSPMode=SPI_NSS_PULSE_DISABLE;                      /* NSS信号脉冲失能 */
    g_spi2_handle.Init.MasterKeepIOState=SPI_MASTER_KEEP_IO_STATE_ENABLE;   /* SPI主模式IO状态保持使能 */
...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi)
{
    ...
    spi2_clk_init.PeriphClockSelection = RCC_PERIPHCLK_SPI2;        /* 设置SPI2时钟源 */
    spi2_clk_init.Spi123ClockSelection = RCC_SPI123CLKSOURCE_PLL;   /* SPI2时钟源使用PLL1Q */
