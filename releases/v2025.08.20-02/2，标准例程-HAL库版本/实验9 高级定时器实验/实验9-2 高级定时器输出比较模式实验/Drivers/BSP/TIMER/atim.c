...
void HAL_TIM_OC_MspInit(TIM_HandleTypeDef *htim)
{
    if (htim->Instance == ATIM_TIMX_COMP)
    {
        ...
        ATIM_TIMX_COMP_CH1_GPIO_CLK_ENABLE();       /* 使能通道1时钟 */
        ATIM_TIMX_COMP_CH2_GPIO_CLK_ENABLE();       /* 使能通道2时钟 */
        ATIM_TIMX_COMP_CH3_GPIO_CLK_ENABLE();       /* 使能通道3时钟 */
        ATIM_TIMX_COMP_CH4_GPIO_CLK_ENABLE();       /* 使能通道4时钟 */
